...
const Founder = () => (
  <Stack direction={['column', 'row']} spacing={['4', '16']} padding={'8'}>
    <VStack>
      <Avatar boxSize={['40', '48']} src={cofounder} />
    ...
    <VStack justifyContent={'center'} alignItems={['center', 'flex-start']}>
      ...
      <Text
        ...
        children={
          'Hi , i am Ful-Stack developer Our mission is to provide quality quantent at reasonable price '
        }
      />
    </VStack>
  </Stack>
      ...
      <Container maxW={'container.xl'} padding={16} boxShadow={'lg'}>
        ...
        <Stack m={'8'} direction={['column', 'row']} alignItems={'center'}>
          <Text fontFamily={'cursive'} m={'8'} textAlign={['center', 'left']}>
            We are a video streammin platfrom with some premium courses
